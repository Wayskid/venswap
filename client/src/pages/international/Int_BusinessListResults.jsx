...
export default function Int_BusinessListResults({
  businessListResult,
  isLoading,
  isError,
  error,
          ...
          >
            <div className="md:row-span-2 border-r grid">
              <div
                ...
                onClick={() => {
                  navigate(`/international/business_details/${business._id}`);
                  updateViewCountApi({
                    token,
            ...
            <div className="flex justify-between items-center w-full px-3 py-[6px]">
              ...
              {business.seller_id._id === userInfo?._id ? (
                ...
                <AppButtonsSecondary
                  ...
                  onClick={() =>
                    navigate(
                      `/international/business_details/${business._id}/contact`
                    )
                  }
                />
              )}
